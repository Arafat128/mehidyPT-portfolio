...
const aboutText =
  "Four+ years deep in Web3, building web apps, tools, AI agents and Discord bots, creating content and helping projects grow communities that actually care. I'm drawn to teams that want to put their best face forward and build something people genuinely want to be part of. Always learning, always shipping. Let's build something incredible together.";
